...
def print_info(info):
    ...
    answer_third_question = "Table attached"
...
if __name__ == '__main__':
    ...
    parser.add_argument('filename', type=str, help='The path to the traceroute file')
    args = parser.parse_args()

    traceroute_data = read_tracefile(args.filename)
    info = TracerouteInfo()
